...
const API_TYPE_CONSTANT = {
  ...
  SUBMIT_PARENT_FEEDBACK: "SUBMIT_PARENT_FEEDBACK",
  GET_PARENT_FEEDBACKS: "GET_PARENT_FEEDBACKS",
  GET_PTM_REPORTS: "GET_PTM_REPORTS",
  GET_CLASS_TIMETABLE: "GET_CLASS_TIMETABLE",
  GET_DATESHEET: "GET_DATESHEET",
  GET_STUDENT_ATTENDANCE: "GET_STUDENT_ATTENDANCE",
  SUBMIT_STUDENT_LEAVES: "SUBMIT_STUDENT_LEAVES",
};
